...
import {
  ...
  FrameData,
  RosterFrameData,
} from '../../../mk11/utils/data/types'
import CharacterPage from '../../../mk11/components/character/CharacterPage'
import LoadingPage from '../../../components/global/LoadingPage'
import { characters } from '../../../mk11/utils/data/characters'
import { GetStaticProps } from 'next'
import { AES, enc } from 'crypto-js'
import encryptedFrameData from '../../../mk11/utils/data/encryptedFrameData.json'
